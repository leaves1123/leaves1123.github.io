...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Modify CSS styles to move the bookmark to the top left corner
  const bookmarkLink = document.querySelector('.book-mark-link');
  if (bookmarkLink) {
    bookmarkLink.style.left = 'auto'; // Adjust the left position as needed
    bookmarkLink.style.right = '100px'; // Reset the right property
  }
});